...
public class ADM {
    ...
    public ADM(int cod_adm, String nome_adm, String cpf_adm, String rg_adm, String rua_adm, String bairro_adm, int numero_adm, String cidade_adm, String telefone_adm, int tipo, String login_adm, String senha_adm) {
